	...
	AdapterListAbout(Activity context, Titular[] datos) {//constructor
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			...
			if(item == null)
			{
				...
				item = inflater.inflate(R.layout.about_itemlist, null);
			}
			
			TextView lblTitulo = (TextView)item.findViewById(R.id.aboutTitle);
			lblTitulo.setText(datos[position].getTitulo());
			
			TextView lblSubtitulo = (TextView)item.findViewById(R.id.aboutSubtitle);
