...
public class ClientesProvider extends ContentProvider {
	...
	private static final String uri = "content://com.example.carlos.contentprovideruse/clientes";
	...
	static {
		...
		uriMatcher.addURI("com.example.carlos.contentprovideruse", "clientes", CLIENTES);
		uriMatcher.addURI("com.example.carlos.contentprovideruse", "clientes/#", CLIENTES_ID);
	}
	...
	public String getType(Uri uri) {
		...
		{
			case CLIENTES: 
				return "vnd.android.cursor.dir/vnd.carlos.cliente";
			case CLIENTES_ID: 
				return "vnd.android.cursor.item/vnd.carlos.cliente";
			default: 
				return null;
		}
	}
